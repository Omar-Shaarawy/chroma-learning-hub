        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8" dir="rtl">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-gray-600 max-w-xs">
              تمكين المعلمين من إنشاء ومشاركة المعرفة من خلال منصتنا الشاملة للتعليم الإلكتروني.
            </p>
          </div>
          ...
          {/* Resources */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">المصادر</h3>
            <ul className="space-y-3">
              <li>
                <Link to="/blog" className="text-gray-600 hover:text-purple-500 transition-colors">
                  المدونة
                </Link>
              </li>
              <li>
